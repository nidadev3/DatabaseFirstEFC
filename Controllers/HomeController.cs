...
namespace DatabaseFirstEFCore.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,StudentName,StudentGender,StudentAge")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,StudentName,StudentGender,StudentAge")] Student student)
        {
